...
# ONLY use relative file paths that start with $(SOURCELIB_ROOT)../
# DO NOT USE absolute file paths (e.g. /home/users/myuser/mydir)
LIBSRCS += $(MYLIB_PATH)/s4743556_lta1000g.c $(MYLIB_PATH)/s4743556_rgb.c $(MYLIB_PATH)/s4743556_mfs_trimpot.c $(MYLIB_PATH)/s4743556_mfs_pb.c $(MYLIB_PATH)/s4743556_mfs_led.c $(MYLIB_PATH)/s4743556_hamming.c $(MYLIB_PATH)/s4743556_console.c $(MYLIB_PATH)/s4743556_sysmon.c $(SOURCELIB_ROOT)/components/os/FreeRTOS/portable/MemMang/heap_2.c
